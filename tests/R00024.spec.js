...
test('R00024', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00024/R00024-1.png', fullPage: true });
    await page.getByRole('link', { name: 'ดูรายชื่อทั้งหมด' }).click();
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00024/R00024-2.png', fullPage: true });
});