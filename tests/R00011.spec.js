...
test('R00011', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00011/R00011-1.png', fullPage: true });
    await page.fill('#username', '');
    await page.fill('#email', 'test02@domain.com');
    await page.fill('#password', 'Test123456');
    await page.fill('#confirm_password', '');
    await page.getByRole('button', { name: 'สมัครสมาชิก' }).click();
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00011/R00011-2.png', fullPage: true });
});