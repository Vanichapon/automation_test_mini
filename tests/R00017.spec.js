...
test('R00017', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00017/R00017-1.png', fullPage: true });
    await page.getByRole('link', { name: 'สมัครสมาชิก' }).click();
    await expect(page).toHaveURL(/register_user/);
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00017/R00017-2.png', fullPage: true });
});