...
test('R00019', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00019/R00019-1.png', fullPage: true });
    await page.fill('#username', 'TestTeam2');
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00019/R00019-2.png', fullPage: true });
});