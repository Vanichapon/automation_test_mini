...
test('R00005', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00005/R00005-1.png', fullPage: true });
    await page.getByRole('link', { name: 'ประกาศ' }).click();
    await expect(page).toHaveURL(/annunciate/);
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00005/R00005-2.png', fullPage: true });
});