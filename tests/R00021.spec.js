...
test('R00021', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00021/R00021-1.png', fullPage: true });
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00021/R00021-2.png', fullPage: true });
});