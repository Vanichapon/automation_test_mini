...
test('R00018', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00018/R00018-1.png', fullPage: true });
    await page.getByText('ตั้งค่า').click();
    await expect(page).toHaveURL(/settings/);
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00018/R00018-2.png', fullPage: true });
});