...
test('R00022', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00022/R00022-1.png', fullPage: true });
    ...
    await page.screenshot({ path: 'C:/automation_test_mini/image/R00022/R00022-2.png', fullPage: true });
});